...
get_required_kitsune_lib_repo "libKitsunemimiCommon" "v0.25.2" 4 "staticlib"

get_required_private_repo_github  "libKitsunemimiCpu" "v0.3.0" 4 "staticlib"

#-----------------------------------------------------------------------------------------------------------------

if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiSakuraHardware" 4 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiSakuraHardware" 4 "staticlib"
fi
